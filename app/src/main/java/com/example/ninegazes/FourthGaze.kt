...
class FourthGaze : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNext.setOnClickListener {
            ...
            val byteArray4 = bitmapToByteArray(imageBitmap4!!)
            val intent = Intent(this, FifthGazeActivity::class.java)
